    ...
    <div class="container px-xl-0">
        <div class="row align-items-center">
            <div class="mb-20 mb-lg-0 col-lg-3" data-aos-duration="600" data-aos="fade-down" data-aos-delay="0">
                <a href="#" class="logo link color-white">Artconnect</a>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5 text-lg-right" data-aos-duration="600" data-aos="fade-down" data-aos-delay="300">
                <div class="text-adaptive">
                   <strong>phone number</strong> 021 766 0080<br>
                   <strong>mobile</strong> 0818 914 729<br>
                   <strong>fax</strong> 021 766 0203<br>
                   <strong>address</strong> Jl. SD 3 No.2, Pondok Pinang,<br>
                   Kebayoran Lama, Jakarta Selatan 12310<br>
                   <strong>more info</strong> info@artconnect.id
                </div>
            </div>
            ...
            <div class="col-lg-5 text-lg-right" data-aos-duration="600" data-aos="fade-down" data-aos-delay="300">
                <div class="text-adaptive">
                    Artconnect
                    &copy; {{ Carbon\Carbon::now()->translatedFormat('Y') }}
                </div>
            </div>
        </div>
    </div>
