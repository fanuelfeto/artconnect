...
@section('title','Sculptures Catalogue')
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Sculptures Catalogue</h1>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a href="{{ route('sculpturesCatalogueDetails',['id' => $product->id])}}" class="mt-30 btn border-gray color-main">See More</a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
