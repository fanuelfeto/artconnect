...
@section('title','Furnitures Catalogue')
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a href="{{ route('furnituresCatalogueDetails',['id' => $product->id])}}" class="mt-30 btn border-gray color-main">See More</a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
